...
def main():
    ...
    parser.add_argument('--model_url', default='https://drive.google.com/uc?id=14s_02wn1RUFQ9Ay-QM_-bj0k8X03VdST', help='Fetch a StyleGAN model to train on from this URL') # karras2019stylegan-ffhq-1024x1024.pkl    parser.add_argument('--model_res', default=1024, help='The dimension of images in the StyleGAN model', type=int)
